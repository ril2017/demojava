...
import cesi.ril.rmiinterface.Book;
import cesi.ril.rmiinterface.RMIInterface;
...
public class Customer {
	...
	public static void main(String[] args) throws MalformedURLException, RemoteException, NotBoundException {
		...
		null, options, options[0]);
			...
			findmore = (JOptionPane.showConfirmDialog(null, "Do you want to exit?", "Exit", JOptionPane.YES_NO_OPTION) == 
